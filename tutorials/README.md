...
- For a notebook versions of a complete RNAseq pipeline from Fastq to Salmon quantification go through these tutorials from [King Lab at The University of Maine INBRE]([https://github.com/MaineINBRE/rnaseq-myco-tutorial](https://github.com/King-Laboratory/rnaseq-myco-notebook). 
