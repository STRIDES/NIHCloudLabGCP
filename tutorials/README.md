...
- For a notebook version of a complete RNAseq pipeline from Fastq to Salmon quantification go through these tutorials from [the King Lab](https://github.com/King-Laboratory/rnaseq-myco-notebook) at The University of Maine INBRE. You run the same tutorial using the Life Sciences API using [this notebook](/tutorials/notebooks/LifeSciencesAPI). 
